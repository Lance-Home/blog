...
[![Release](https://img.shields.io/github/release/Lance/mblog.svg?style=flat-square)](https://github.com/Lance/mblog)
[![license](https://img.shields.io/badge/license-GPL--3.0-green.svg)](https://github.com/Lance/mblog/blob/master/LICENSE)
[![Docker](https://img.shields.io/docker/automated/Lance/mblog.svg?style=flat-square)](https://hub.docker.com/r/Lance/mblog)
...
- 文档: [说明文档](https://Lance.github.io/mblog/#/)
...
### 版本(3.0)更新内容：
    ...
    11. 我的主页和Ta人主页合并
    12. 优化了图片裁剪功能
    13. 支持Docker, 详情见 https://hub.docker.com/r/Lance/mblog
    14. 邮件服务后台可配
    15. 新增标签页
