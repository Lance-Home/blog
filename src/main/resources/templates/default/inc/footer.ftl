        ...
        <div class="footer-row">
            <nav class="footer-nav">
                <a class="footer-nav-item footer-nav-logo" href="${base}/">
                    <img src="<@resource src=options['site_logo']/>" alt="信哥的博客"/>
                </a>
            ...
            <div class="gh-foot-min-back hidden-xs hidden-sm">
                <!-- 请保留此处标识-->
                <span class="footer-nav-item"> <a href="https://www.aliyun.com/minisite/goods?userCode=4rzkdozy&utm_source=4rzkdozy" target="_blank">阿里云优惠</a></span>
            </div>
        </div>
    </div>
</footer>
