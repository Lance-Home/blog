...
<head>
    ...
    <!-- Favicons -->
    <link rel="apple-touch-icon-precomposed" href="https://lance-blogs.oss-cn-shanghai.aliyuncs.com/header/login.png"/>
    <link rel="shortcut icon" href="https://lance-blogs.oss-cn-shanghai.aliyuncs.com/header/logo.png"/>
...
<div class="wrapper">
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2020 <a href="#">As free as wind</a>.</strong> All rights reserved.
    </footer>
</body>
</html>
</#macro>
